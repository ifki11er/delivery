  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-1">
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-2">
              <Link href="/login/find-id" className="text-xs text-indigo-200 hover:text-white transition-colors">이메일 찾기</Link>
              <span className="text-xs text-indigo-200">|</span>
              <Link href="/login/forgot" className="text-xs text-indigo-200 hover:text-white transition-colors">비밀번호 찾기</Link>
            </div>
          </div>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        ...
        >
          {loading ? '로그인 처리 중...' : '이메일로 계속하기 (로그인/가입)'}
        </button>
      </form>
